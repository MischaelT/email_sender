...
from business_logic.const import INITIAL, FIRST, SECOND, THIRD, FOURTH


class prebidTemplate(Template):
    ...
    def generate_initial_email(cls, website_name: str) -> dict:
        ...
        initial_email = {'subject': f'Advertising Inquiry — {website_name} x {COMPANY_NAME}',
                         'text': f'''
...
Best regards, {FULL_NAME}
    ...
    def generate_first_followUp_email(cls, website_name: str) -> dict:
        ...
        """
        greeting = random.choice(cls.greetings_list)
        first_followUp_email = {'subject': f'Advertising Inquiry — {website_name} x {COMPANY_NAME}',
                                'text': f'''
{greeting}
...
Best regards, {FULL_NAME}
    ...
    def generate_second_followUp_email(cls, website_name: str) -> dict:
        ...
        """
        greeting = random.choice(cls.greetings_list)
        second_followUp_email = {'subject': f'Advertising Inquiry — {website_name} x {COMPANY_NAME}',
                                 'text': f'''
{greeting}
...
'''
    ...
    def generate_third_followUp_email(cls, website_name: str) -> dict:
        ...
        """
        greeting = random.choice(cls.greetings_list)
        third_followUp_email = {'subject': f'Advertising Inquiry — {website_name} x {COMPANY_NAME}',
                                'text': f'''
{greeting}
...
Best regards, {FULL_NAME}
    ...
    def generate_fourth_followUp_email(cls, website_name: str) -> dict:
        ...
        """
        greeting = random.choice(cls.greetings_list)
        fourth_followUp_email = {'subject': f'Advertising Inquiry — {website_name} x {COMPANY_NAME}',
                                 'text': f'''
{greeting}
